/* 预设课表：手机首次打开、或在「管理 → 数据 → 载入预设课表」时会读这里。
   ...
   courses：每门课一行
     ...
     day  1~7（周一~周日）
     start/end 第几节到第几节（对应「节次时间」里的编号）
...
window.SEED = {
  ...
  courses: [
    ...
    { name: '机械制图', teacher: '蓝雄', loc: 'T3-C516', day: 1, start: 6, end: 7, wl: '4-5', color: '#7c3aed' },
    { name: '信息技术', teacher: '覃家运', loc: 'T1-A503', day: 1, start: 6, end: 7, wl: '7-10', color: '#0f766e' },
    { name: '信息技术', teacher: '覃家运', loc: 'T1-A504', day: 1, start: 6, end: 7, wl: '13-14', color: '#0f766e' },
    ...
    { name: '信息技术', teacher: '覃家运', loc: 'T1-A505', day: 3, start: 6, end: 7, wl: '16', color: '#0f766e' },
    ...
    { name: '信息技术', teacher: '覃家运', loc: 'T1-A505', day: 4, start: 6, end: 7, wl: '3-4,6,7-9', color: '#0f766e' },
    { name: '信息技术', teacher: '覃家运', loc: 'T1-A504', day: 4, start: 6, end: 7, wl: '13-15', color: '#0f766e' },
